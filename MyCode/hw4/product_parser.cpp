...
Product* ProductBookParser::makeProduct() {
	...
	Product *newBookProduct = new Book("book", prodName_, price_, qty_, author_, isbn_);
...
Product* ProductClothingParser::makeProduct() {
	...
	Product *newClothingProduct = new Clothing("clothing", prodName_, price_, qty_, size_, brand_);
...
Product* ProductMovieParser::makeProduct() {
	...
	Product *newMovieProduct = new Movie("movie", prodName_, price_, qty_, genre_, rating_);
	return newMovieProduct; 
